...
import { ComboAmdSpecs } from "./comboAmdSpecs";

interface ComboAmdSpecsViewProps {
  specs: ComboAmdSpecs;
}

export default function ComboAmdSpecsView({ specs }: ComboAmdSpecsViewProps) {
  return (
    <div className="mt-10">
      <h2 className="text-xl font-semibold mb-4 text-gray-800">
        Especificaciones Combo AMD
      </h2>
