...
export const Footer = () => {
  return (
    // <div className="bg-text-muted py-12 ">
    //   <div className="custom-container">
    //     <div className="flex flex-col">
    //       <h4 className="text-accent text-[15px] font-medium mb-5">
    //         ATENCIÓN AL CLIENTE
    //       </h4>
    ...
    //       <span className="text-white text-base font-semibold uppercase mb-5">
    ...
    //           className="bg-white p-2.5 pr-10 rounded-sm w-full"
    //         />
    //         <div className="absolute right-0 top-0 h-full w-12 bg-accent flex items-center justify-center cursor-pointer">
  ...
  <div className="custom-container">
    ...
    <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-12">
      ...
      <div className="mt-4 md:mt-0 flex flex-col">
        ...
        <div className="relative w-full mb-5">
          ...
          />
          <div className="absolute right-0 top-0 h-full w-12 bg-accent flex items-center justify-center cursor-pointer rounded-sm">
            <BiSolidRightArrow className="w-6 h-6 text-white" />
          </div>
        </div>
        <div className="flex gap-4">
    ...
    <div className="flex items-center justify-center mt-16">
      <p className="text-[14px] text-white/90">Copyright © 2025 - Hard360. Córdoba, Argentina.</p>
    </div>
  </div>
</div>
  );
